...
function renderTypeIcon(tipo: string, size = 32, color = "#1591DC") {
  switch (tipo) {
    case 'curso':
  ...
  return (
    <div className="detail-screen">
      ...
      <div className="detail-hero">
        ...
        <span className={`status-badge status-${submission.status || 'pendente'}`}>
          {(!submission.status || submission.status === 'pendente') ? 'Sob análise' : submission.status}
        </span>
      </div>
